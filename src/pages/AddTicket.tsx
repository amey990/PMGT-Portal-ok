...
//   // Dummy options; replace with real data hooks
...
//     ticketNo: 'T-' + Math.floor(1000 + Math.random()*9000), // dummy next ticket
...
//     // TODO: submit to backend & reset form
...
//       <Box sx={{ pt:2, px:2 }}>
//         <Card sx={{ bgcolor:'#1C1C1E', borderRadius:2, height:'calc(100vh - 84px)', overflow:'hidden' }}>
//           <CardContent
//             sx={{
//               height:'100%',
//               display:'flex',
...
//       >
//         <Alert onClose={handleToastClose} severity="success" variant="outlined">
//           {toast.message}
//         </Alert>
//       </Snackbar>
//     </MainLayout>
      ...
      <Box sx={{ pt:2, px:2 }}>
        ...
        >
          ...
          >
            ...
            {/* Add button */}
            <Box sx={{ pb:1,mb:3,mr:1, textAlign:'right' }}>
              <Button
                variant="contained"
                onClick={handleAdd}
                sx={{ 
